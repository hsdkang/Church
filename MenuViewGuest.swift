        ...
        VStack{
            Button ("교회소개"){
                withAnimation(.easeOut(duration: 0.3)){
                    self.viewRouter.currentPage = "IntroViewGuest"
                }
            }.font(.system(size: 20))
            ...
            Button ("교회소식"){
                withAnimation(.easeOut(duration: 0.3)){
                    self.viewRouter.currentPage = "NewsViewGuest"
                }
            }.font(.system(size: 20))
                .frame(width: 250, height: 70, alignment: .center)
                .background(Color.white)
            ...
            Button ("교회행사"){
                withAnimation(.easeOut(duration: 0.3)){
                    self.viewRouter.currentPage = "EventViewGuest"
                }
            }.font(.system(size: 20))
                .frame(width: 250, height: 70, alignment: .center)
                .background(Color.white)
            ...
            Button ("목장소식"){
                withAnimation(.easeOut(duration: 0.3)){
                    self.viewRouter.currentPage = "CommunityViewGuest"
                }
            }.font(.system(size: 20))
                .frame(width: 250, height: 70, alignment: .center)
                .background(Color.white)
...
struct MenuViewGuest_Previews: PreviewProvider {
